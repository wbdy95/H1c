...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation  Browser\
                     FusedLocation PrintSpooler SharedStorageBackup  ExternalStorageProvider InputDevices \
                     ProxyHandler Shell DefaultContainerService CMSettingsProvider  SRSMusicFX 
...
override_property += \
    ro.flyme.romer=wbdy \
    ro.product.model_romer=H1c_wbdy
